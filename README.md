...
|2|[Прогнозирование оттока клиентов фитнес-центра](https://github.com/pyrrow0w/Yandex_practicum/tree/main/Monetization%20model)|Услуги|EDA, построение модели бинарной классификации по признаку оттока, кластеризация клиентов|`Pandas` `Seaborn` `Matplotlib` `Sklearn` `SciPy`|
